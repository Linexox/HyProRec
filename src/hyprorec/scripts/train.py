...
def _build_model(
    ...
    config = HoCRSConfig(
        ...
        use_sample_conditional_gate=model_args.use_sample_conditional_gate,
        use_residual_injection=model_args.use_residual_injection,
        gate_hidden_dim=model_args.gate_hidden_dim,
        residual_scale_init=model_args.residual_scale_init,
