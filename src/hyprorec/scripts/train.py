...
def _build_model(
    ...
    config = HoCRSConfig(
        ...
        use_user_moe=model_args.use_user_moe,
        user_moe_num_experts=model_args.user_moe_num_experts,
        user_moe_hidden_dim=model_args.user_moe_hidden_dim,
        user_moe_router_temperature=model_args.user_moe_router_temperature,
        user_moe_residual_scale_init=model_args.user_moe_residual_scale_init,
